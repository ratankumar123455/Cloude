const frames = [
  { id: "01", tone: "linear-gradient(150deg, rgba(91,95,255,0.5), rgba(27,36,38,0.92) 70%)" },
  { id: "02", tone: "linear-gradient(150deg, rgba(0,229,255,0.35), rgba(27,36,38,0.92) 70%)" },
  { id: "03", tone: "linear-gradient(150deg, rgba(139,92,246,0.55), rgba(27,36,38,0.92) 70%)", active: true },
  { id: "04", tone: "linear-gradient(150deg, rgba(91,95,255,0.25), rgba(27,36,38,0.92) 70%)" },
];
  ...
  return (
    <div className="relative mx-auto w-full max-w-md py-12 lg:mx-0">
      <div
        ...
        style={{
          background:
            "radial-gradient(220px circle at 30% 20%, rgba(91,95,255,0.35), transparent 65%), radial-gradient(260px circle at 80% 70%, rgba(0,229,255,0.18), transparent 65%)",
        }}
        aria-hidden="true"
      />
            ...
            <div key={frame.id} className="relative">
              <div
                ...
                style={{
                  ...
                  boxShadow: frame.active ? "0 0 0 2px rgba(91,95,255,0.25)" : "none",
                }}
              />
